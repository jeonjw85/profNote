...
export async function fetchSettings(): Promise<Settings> {
  ...
  return SettingsSchema.parse({
    ...
    diarizationPython: values.get("diarization_python") ?? "",
    diarizationScript: values.get("diarization_script") ?? "",
...
export async function saveSettings(settings: Settings): Promise<void> {
  ...
  const entries: Array<[string, string]> = [
    ...
    ["diarization_python", settings.diarizationPython],
    ["diarization_script", settings.diarizationScript],
